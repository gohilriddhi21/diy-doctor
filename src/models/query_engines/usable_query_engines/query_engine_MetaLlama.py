...
# query_engine_MetaLlama.py - Child class to use meta-llama/llama-3.2-3b-instruct:free model as query engine
...
class QueryEngineMetaLlama(QueryEngineBase):
    """
    Usable query engine with the meta-llama/llama-3.2-3b-instruct:free LLM model
    """
